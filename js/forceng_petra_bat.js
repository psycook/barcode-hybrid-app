...
angular.module('forceng', [])
  ...
  .factory('force', function ($rootScope, $q, $window, $http) {
    ...
    var loginURL = 'https://distributrocdo.my.salesforce.com',
    ...
    // To override default, pass appId in init(props)
      appId = '3MVG98_Psg5cppybeaoMGz_Pi_O8U8Krnlbxqli7MeEvs_Of9w5NoGHjqghnER0h5lppldMNkjAJnxLuI48xT',
    ...
    function addAttachment(attachment) {
      ...
      return request({
        method: 'POST',
        contentType: 'application/json',
        path: '/services/data/' + apiVersion + '/sobjects/Attachment/',
        data: attachment
      });
